...
![RSMA 辅助的星地融合 Cell-Free Massive MIMO 框架](./assets/rsma-ist-cf-mimo-framework.svg)

图 1：根据论文思路重新绘制的 RSMA-aided IST-CF-mMIMO 上行处理框架，展示用户消息拆分、AP/LEO 卫星协作接收、CPU 合并检测和 FP 功率控制闭环，非论文原图。
